...
A `goose-android` client is planned to effectively be a port of the `goose-ios` project, a client to a remote goose, and will be available on google play store eventually

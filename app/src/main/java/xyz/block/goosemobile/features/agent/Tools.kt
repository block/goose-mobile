package xyz.block.goosemobile.features.agent
...
import xyz.block.goosemobile.features.agent.Content
import xyz.block.goosemobile.features.agent.Message
import xyz.block.goosemobile.features.agent.Conversation
    ...
    */
    ...
    fun searchPastConversations(context: Context, args: JSONObject): String {
        ...
        selectedConversations.forEachIndexed { index, conversation ->
            ...
            val title = xyz.block.goosemobile.features.agent.getConversationTitle(conversation)
            ...
            relevantMessages.forEach { message ->
                ...
                val messageText = xyz.block.goosemobile.features.agent.firstText(message)
    ...
    fun getLastConversationContext(context: Context, args: JSONObject): String {
        ...
        val title = xyz.block.goosemobile.features.agent.getConversationTitle(lastConversation)
        val formattedDate = java.text.SimpleDateFormat(
            "MMM d, yyyy 'at' h:mm a", 
            java.util.Locale.getDefault()
        ...
        if (lastUserMessage != null) {
            val userText = xyz.block.goosemobile.features.agent.firstText(lastUserMessage)
        ...
        if (lastAssistantMessage != null) {
            val assistantText = xyz.block.goosemobile.features.agent.firstText(lastAssistantMessage)
    ...
    fun notificationHandler(context: Context, args: JSONObject): String {
        ...
        val settings = xyz.block.goosemobile.features.settings.SettingsStore(context)

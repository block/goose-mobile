...
import xyz.block.goosemobile.shared.navigation.NavGraph
...
class MainActivity : ComponentActivity() {
    ...
    override fun onResume() {
        super.onResume()
        GooseMobileApplication.isMainActivityRunning = true
    ...
    override fun onPause() {
        super.onPause()
        GooseMobileApplication.isMainActivityRunning = false
        OverlayService.getInstance()?.updateOverlayVisibility()
    }

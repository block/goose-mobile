package xyz.block.goosemobile.features.assistant
...
import xyz.block.goosemobile.features.accessibility.GooseMobileAccessibilityService
import xyz.block.goosemobile.features.agent.Agent
import xyz.block.goosemobile.features.agent.AgentServiceManager
import xyz.block.goosemobile.features.agent.AgentStatus
import xyz.block.goosemobile.features.agent.ToolHandler.buildCompactHierarchy
import xyz.block.goosemobile.features.overlay.OverlayService
import xyz.block.goosemobile.shared.services.VoiceRecognitionService
...
class AssistantActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent?.action == Intent.ACTION_ASSIST) {
            ...
            val accessibilityService = GooseMobileAccessibilityService.getInstance()

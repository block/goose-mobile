package xyz.block.goosemobile.features.overlay
...
class OverlayService : Service() {
    ...
    override fun onCreate() {
        ...
        GooseMobileApplication.enableOverlay()
    ...
    fun updateOverlayVisibility() {
        overlayView?.post {
            val shouldShow = !GooseMobileApplication.shouldHideOverlay() && isPerformingAction

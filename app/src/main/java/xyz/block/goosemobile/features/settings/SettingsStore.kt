package xyz.block.goosemobile.features.settings
...
import xyz.block.goosemobile.features.agent.AiModel
import xyz.block.goosemobile.features.agent.ModelProvider
...
class SettingsStore(context: Context) {
    ...
    companion object {
        private const val PREFS_NAME = "goose_mobile_prefs"
        private const val SECURE_PREFS_NAME = "goose_mobile_secure_prefs"
